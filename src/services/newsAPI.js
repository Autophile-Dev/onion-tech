...
const latest_news = async () => {
    try {
        return await axios
            .get(baseurl + 'data/v2/news/?lang=EN', { headers: headers })
    } catch (error) {
        return error;
    }
}
...
const topBTCNews = async () => {
    try {
        return await axios
            .get(baseurl + 'data/v2/news/?categories=BTC&lang=EN', { headers: headers })
    } catch (error) {
        return error;
    }
}
const topETHNews = async () => {
    try {
        return await axios
            .get(baseurl + 'data/v2/news/?categories=ETH&lang=EN', { headers: headers })
    } catch (error) {
        return error;
    }
}
