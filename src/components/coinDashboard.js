...
const CoinDashboard = ({ item }) => {
    ...
    // const openHour = item.Data.DISPLAY.RAW.USD.OPENHOUR;
    // const chartData = [
    //     parseFloat(item.DISPLAY.OPENHOUR)
    // ];
    return (
        <TouchableOpacity onPress={openLink} style={style.container}>
            <View style={style.chart}>
                {priceChangePercentage7d > 0
                    ? <Image style={style.chartImage} source={require('../assets/icons/Vector6.png')} /> :
                    <Image style={style.chartImage} source={require('../assets/icons/graph_low.png')} />
                }
            </View>
            <View style={style.cardHeadContainer}>
                <View style={style.headContentLeft}>
                ...
                <View style={style.headContentRight}>
